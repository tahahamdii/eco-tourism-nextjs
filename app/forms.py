...
class SoilFertilityForm(forms.Form):
    soil_ph = forms.FloatField(label="Soil pH", min_value=0, max_value=14, initial=6.5)
    moisture = forms.FloatField(label="Moisture Level (%)", min_value=0, max_value=100, initial=30)
    nitrogen = forms.FloatField(label="Nitrogen (mg/kg)", min_value=0, max_value=100, initial=50)
    phosphorus = forms.FloatField(label="Phosphorus (mg/kg)", min_value=0, max_value=100, initial=50)
    potassium = forms.FloatField(label="Potassium (mg/kg)", min_value=0, max_value=100, initial=50)
    organic_matter = forms.FloatField(label="Organic Matter (%)", min_value=0, max_value=100, initial=5)
...
class PredictionForm(forms.Form):
    CITY_CHOICES = [
        ...
        ("Gabès", "Gabès"), ("Kairouan", "Kairouan"), ("Monastir", "Monastir"),
        ("Mahdia", "Mahdia"), ("Bizerte", "Bizerte"), ("Nabeul", "Nabeul"), ("Tozeur", "Tozeur")
    ]
